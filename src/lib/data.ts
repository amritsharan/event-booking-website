...
export const events: Event[] = [
  ...
  },
  {
    ...
    longDescription: 'Innovate Summit 2024 brings together the brightest minds in tech for three days of keynotes, workshops, and networking. Hear from industry giants, discover disruptive startups, and get hands-on with the latest technologies that are shaping our world. Your ticket to the future starts here.',
    date: '2025-01-10',
    time: '09:00 - 17:00',
...
export const reservations: Reservation[] = [
  {
    id: 'r1',
    eventId: '3',
    eventName: 'Innovate Summit 2024',
    date: '2025-01-10',
    location: 'Silicon Valley Convention Center',
    status: 'upcoming',
    ...getImage('tech-conference'),
